        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav nav justify-content-end">
                    <div class="btn-group">
                        <a href="/profile">
                            <button type="button" class="btn btn-danger">Fulano de Tal</button>
                        </a>
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="/profile">Curr&iacute;culo</a>
                            <a class="dropdown-item" href="/lista">Lista de vagas</a>
                            <a class="dropdown-item" href="/criar">Criar vaga</a>
